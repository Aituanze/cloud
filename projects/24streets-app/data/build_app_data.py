...
DISTRICT_META = {
    # Ориентация: юг=верх, север=низ, запад=лево, восток=право
    # З→В: наур → ауэз → бост → алма(центр) → меде → жет → турк
    'naur': {'name': 'Наурызбайский', 'color': '#dc4446', 'cx': 22,  'cy': 96,  'r': 18},
    'bost': {'name': 'Бостандыкский', 'color': '#15966b', 'cx': 62,  'cy': 78,  'r': 22},
    'mede': {'name': 'Медеуский',     'color': '#2d6be4', 'cx': 114, 'cy': 70,  'r': 18},
    'auez': {'name': 'Ауэзовский',    'color': '#c060a0', 'cx': 46,  'cy': 118, 'r': 14},
    'alma': {'name': 'Алмалинский',   'color': '#e07b2a', 'cx': 85,  'cy': 118, 'r': 24},
    'zhet': {'name': 'Жетысуский',    'color': '#7055c0', 'cx': 128, 'cy': 126, 'r': 21},
    'alat': {'name': 'Алатауский',    'color': '#3b7dd8', 'cx': 52,  'cy': 162, 'r': 20},
    'turk': {'name': 'Турксибский',   'color': '#14b89c', 'cx': 120, 'cy': 162, 'r': 15},
}
districts_js = []
