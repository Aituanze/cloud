...
- [ ] **24Streets App** — рабочий прототип в `projects/24streets-app/`
  - [x] Screen 1: Pulse Map интерактивная (карта + тоггл + фильтры)
  - [x] Screen 2: TikTok-лента (scroll-snap + фиксация в базу + reveal телефона)
  - [x] Screen 3: Моя База (В работе / Сохранённые + пустые состояния)
  - [x] Screen 4: Профиль (статистика + настройки)
  - [x] Таб-бар: Карта / База / Профиль
  - [x] Подключить реальные данные из krisha-parser
