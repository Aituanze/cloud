...
SCRIPTS = [
    ...
    HERE.parent.parent / "agnt-24-app" / "data" / "build_app_data.py",
]

REPO_ROOT = HERE.parent.parent.parent
DATA_FILES = [
    "projects/agnt-24/inbox/realty-catalog/data/listings.js",
    "projects/agnt-24/inbox/realty-quick-match/data/listings.js",
    "projects/agnt-24-app/data/listings.js",
]
...
def run_pipeline() -> None:
    ...
    lines = [f"🏠 agnt.24 pipeline — {started}", f"Скриптов выполнено: {ok_count}/{len(results)}", ""]
